...
read.xlsx('C:/Users/fragr/Dropbox/GitHub/fasteR/PSI 연습용.xlsx')

```

```{r, message = FALSE}

PSI_ORIGINAL <- read.xlsx('C:/Users/fragr/Dropbox/GitHub/fasteR/PSI 연습용.xlsx') %>% 
...
2) mpg(miles per gallon), cyl(number of cylinders), hp(gross horsepower) 변수만을 선택하라.
